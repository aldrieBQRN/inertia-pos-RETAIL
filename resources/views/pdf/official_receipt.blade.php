    ...
    <div class="receipt-container">
        <table class="header-table">
            <tr>
                <td width="60%">
                    ...
                    @endif
                    <div class="brand-name font-black text-uppercase tracking-widest">{{ $appName }}</div>
                ...
                <td width="40%" class="text-right">
                    ...
                    <div style="margin-top: 10px; font-size: 10px; color: #6b7280;">
                        ...
                        Ref No: <strong style="color: #111827;">{{ $payment->reference_number }}</strong>
                    </div>
        ...
        <table class="info-table">
            <tr>
                <td width="50%">
                    ...
                    <div style="font-size: 13px; font-weight: 900; color: #111827;">{{ $payment->full_name }}</div>
                    <div style="color: #6b7280;">{{ $payment->store->name }}</div>
                </td>
        ...
        <table class="details-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $payment->plan->duration_months }} Month(s)</td>
                    <td class="text-right font-black">&#8369;{{ number_format($payment->amount, 2) }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="total-box">
            ...
            <div style="font-size: 9px; color: #9ca3af; margin-top: 10px;">
                VAT (12%) Included: &#8369;{{ number_format($payment->amount * 0.12, 2) }}
            </div>
        </div>

        <div class="footer">
            <p>Thank you for your business. Your subscription has been successfully extended until <strong>{{ $payment->store->subscription_ends_at->format('F d, Y') }}</strong>.</p>
            <p>This is a computer-generated document authorized by the <strong>{{ $appName }}</strong> Billing Department. No physical signature is required.</p>
