                                                    ...
                                                    {auth.user.is_admin ? (
                                                        ...
                                                        <div className="flex justify-center gap-1.5">
                                                            <button 
                                                                ...
                                                                className="p-1.5 text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors border border-gray-150 shadow-sm inline-flex items-center justify-center" 
                                                                title="Print Labels"
                                                            >
                                                            ...
                                                            <button 
                                                                ...
                                                                className="p-1.5 text-green-500 hover:text-green-700 hover:bg-green-100 rounded-lg transition-colors border border-green-150 shadow-sm inline-flex items-center justify-center" 
