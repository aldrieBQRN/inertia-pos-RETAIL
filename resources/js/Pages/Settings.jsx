                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-2 sm:gap-8 lg:gap-12 items-start animate-in fade-in sm:slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="lg:col-span-4 space-y-2 sm:space-y-6">
                            <div className="bg-white sm:rounded-2xl sm:shadow-[0_2px_8px_rgb(0,0,0,0.04)] border-y sm:border border-gray-200/60 p-6 sm:p-8 text-center relative overflow-hidden flex flex-col items-center">
                                ...
                                {/* Cashier Store Details (Address & Phone) shown in left card */}
                                {!user?.is_admin && (
                                    <div className="w-full mt-4 pt-4 border-t border-gray-100 text-left space-y-3 relative z-10">
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Address</span>
                                            <span className="text-sm font-semibold text-gray-800 leading-relaxed">{settings.address || 'Not Configured'}</span>
                                        </div>
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Phone</span>
                                            <span className="text-sm font-semibold text-gray-800 leading-relaxed">{settings.phone || 'Not Configured'}</span>
                                        </div>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="lg:col-span-8 space-y-2 sm:space-y-6 lg:space-y-8 pb-10 sm:pb-0">
                            ...
                            {/* Store Details Accordion (Admin Only) */}
                            {user?.is_admin && (
                                ...
                                <>
                                    ...
                                    <div className="bg-white sm:rounded-2xl sm:shadow-[0_2px_8px_rgb(0,0,0,0.04)] border-y sm:border border-gray-200/60 overflow-hidden">
                                        ...
                                        >
                                            ...
                                            <svg 
                                                className={`w-5 h-5 text-gray-400 group-hover:text-gray-700 transition-transform duration-200 ${openSections.hardware ? 'rotate-180' : ''}`} 
                                                fill="none" 
                                                viewBox="0 0 24 24" 
                                                stroke="currentColor"
                                                strokeWidth="2.5"
