            ...
            <div className="pb-24 sm:pb-8 bg-gray-50 min-h-screen">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 space-y-4 sm:space-y-6 lg:space-y-8 py-4 sm:py-6 lg:py-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                        ...
                        <div className="bg-gray-900 p-4 sm:p-6 lg:p-8 rounded-none shadow-lg relative overflow-hidden group animate-in fade-in slide-in-from-bottom-4 duration-500 h-auto min-h-fit border-y sm:border-0">
                        ...
                        <div className="bg-blue-600 p-4 sm:p-6 lg:p-8 rounded-none shadow-lg shadow-blue-200/50 relative overflow-hidden group animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100 h-auto min-h-fit border-y sm:border-0">
                            <div className="absolute top-0 right-0 p-4 sm:p-6 lg:p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                        ...
                        {/* ACTIVE STORES CARD */}
                        <div className="bg-white border-y sm:border border-gray-100 p-4 sm:p-6 lg:p-8 rounded-none shadow-sm flex flex-col justify-center animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 h-auto min-h-fit">
                            ...
                            <Link href={route('developer.tenants')} className="text-blue-600 text-[9px] sm:text-xs lg:text-sm font-bold mt-2 sm:mt-3 hover:text-blue-800 active:text-blue-900 transition-colors inline-flex items-center gap-1 uppercase tracking-wider w-max rounded-none p-1 hover:bg-blue-50">
                    ...
                    <div className="pt-2 sm:pt-4 lg:pt-6">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-5">
                            ...
                            {/* PENDING APPROVALS */}
                            <Link href={route('developer.payments.pending')} className="bg-white p-3 sm:p-4 lg:p-6 rounded-none border border-gray-100 hover:border-orange-200 hover:bg-orange-50/30 active:bg-orange-100/50 transition-all group relative flex flex-col items-center text-center min-h-24 sm:min-h-28 justify-center">
                                {safeStats.pending > 0 && (
                                    <span className="absolute -top-2 -right-2 flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-none bg-orange-500 text-white text-[8px] sm:text-[10px] font-black shadow-sm">
                                        {safeStats.pending}
                                    </span>
                                )}
                                <div className="bg-orange-50 w-9 h-9 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-none flex items-center justify-center text-orange-500 mb-2 sm:mb-3 group-hover:scale-110 transition-transform flex-shrink-0">
                            ...
                            {/* OVERDUE */}
                            <Link href={route('developer.payments.overdue')} className="bg-white p-3 sm:p-4 lg:p-6 rounded-none border border-gray-100 hover:border-red-200 hover:bg-red-50/30 active:bg-red-100/50 transition-all group relative flex flex-col items-center text-center min-h-24 sm:min-h-28 justify-center">
                                {safeStats.overdue > 0 && (
                                    <span className="absolute -top-2 -right-2 flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-none bg-red-600 text-white text-[8px] sm:text-[10px] font-black shadow-sm animate-pulse">
                                        {safeStats.overdue}
                                    </span>
                                )}
                                <div className="bg-red-50 w-9 h-9 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-none flex items-center justify-center text-red-600 mb-2 sm:mb-3 group-hover:scale-110 transition-transform flex-shrink-0">
                            ...
                            {/* UPCOMING */}
                            <Link href={route('developer.payments.upcoming')} className="bg-white p-3 sm:p-4 lg:p-6 rounded-none border border-gray-100 hover:border-blue-200 hover:bg-blue-50/30 active:bg-blue-100/50 transition-all group relative flex flex-col items-center text-center min-h-24 sm:min-h-28 justify-center">
                                {safeStats.upcoming > 0 && (
                                    <span className="absolute -top-2 -right-2 flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-none bg-blue-600 text-white text-[8px] sm:text-[10px] font-black shadow-sm">
                                        {safeStats.upcoming}
                                    </span>
                                )}
                                <div className="bg-blue-50 w-9 h-9 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-none flex items-center justify-center text-blue-600 mb-2 sm:mb-3 group-hover:scale-110 transition-transform flex-shrink-0">
                            ...
                            {/* HISTORY */}
                            <Link href={route('developer.payments.history')} className="bg-white p-3 sm:p-4 lg:p-6 rounded-none border border-gray-100 hover:border-gray-300 hover:bg-gray-50/50 active:bg-gray-100/50 transition-all group flex flex-col items-center text-center min-h-24 sm:min-h-28 justify-center">
                                <div className="bg-gray-100 w-9 h-9 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-none flex items-center justify-center text-gray-600 mb-2 sm:mb-3 group-hover:scale-110 transition-transform flex-shrink-0">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 pt-2 sm:pt-4 lg:pt-6">
                        ...
                        <div className="lg:col-span-2 bg-white p-4 sm:p-6 lg:p-8 rounded-none border-y sm:border border-gray-100 shadow-sm flex flex-col justify-between">
                            <div>
                                ...
                                <div className="space-y-4 sm:space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full bg-red-100 rounded-none h-2 sm:h-2.5 flex overflow-hidden">
                                    ...
                                    <div>
                                        ...
                                        <div className="w-full bg-gray-100 rounded-none h-2 sm:h-2.5">
                                            <div className="bg-blue-500 h-full rounded-none w-[99.98%]"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-100 flex items-center justify-between">
                                <span className="text-[8px] sm:text-[9px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                                    <span className="relative flex h-2 w-2 sm:h-2.5 sm:w-2.5">
                                        ...
                                        <span className="relative inline-flex rounded-none h-full w-full bg-green-500"></span>
                                    </span>
                                    All Systems OK
                                </span>
                            </div>
                        ...
                        <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-none border-y sm:border border-gray-100 shadow-sm">
                            ...
                            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
                                <Link href={route('developer.broadcasts')} className="flex items-center justify-between p-2.5 sm:p-3 lg:p-4 rounded-none border border-gray-100 hover:border-blue-200 hover:bg-blue-50/50 active:bg-blue-100/30 transition-all group min-h-16 sm:min-h-auto">
                                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 min-w-0">
                                        <div className="bg-blue-100 text-blue-600 p-2 sm:p-2.5 rounded-none group-hover:scale-110 transition-transform flex-shrink-0">
                                ...
                                <Link href={route('developer.billing')} className="flex items-center justify-between p-2.5 sm:p-3 lg:p-4 rounded-none border border-gray-100 hover:border-blue-200 hover:bg-blue-50/50 active:bg-blue-100/30 transition-all group min-h-16 sm:min-h-auto">
                                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 min-w-0">
                                        <div className="bg-indigo-100 text-indigo-600 p-2 sm:p-2.5 rounded-none group-hover:scale-110 transition-transform flex-shrink-0">
                                ...
                                <Link href={route('developer.system.info')} className="flex items-center justify-between p-2.5 sm:p-3 lg:p-4 rounded-none border border-gray-100 hover:border-blue-200 hover:bg-blue-50/50 active:bg-blue-100/30 transition-all group min-h-16 sm:min-h-auto">
                                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 min-w-0">
                                        <div className="bg-gray-100 text-gray-600 p-2 sm:p-2.5 rounded-none group-hover:scale-110 transition-transform flex-shrink-0">
