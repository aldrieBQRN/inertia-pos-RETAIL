            ...
            {products.map((product) => {
                ...
                return (
                    <div
                        ...
                        className={`bg-white rounded-lg shadow-sm border border-gray-100 p-4 flex flex-col h-full transition-all
                            ${isOutOfStock
                    ...
                    >
                        ...
                        <div className="h-24 bg-gray-50 rounded-md mb-3 flex items-center justify-center overflow-hidden relative border border-gray-100">
                            {product.image_path ? (
