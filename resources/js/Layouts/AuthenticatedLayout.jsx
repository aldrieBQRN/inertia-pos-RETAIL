    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            {auth.is_impersonating && (
                <div className="bg-red-600 text-white px-4 py-2 flex justify-between items-center text-sm font-bold z-[100] relative shadow-md">
                    <span className="flex items-center gap-2">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                        You are viewing the system as {user.name}.
                    </span>
                    <form action={route('impersonate.leave')} method="POST">
                        <input type="hidden" name="_token" value={usePage().props.auth.csrf_token || ''} />
                        <button type="submit" className="bg-white text-red-600 px-3 py-1.5 rounded shadow hover:bg-red-50 active:scale-95 transition-all uppercase tracking-wider text-xs font-black">
                            Return to Admin
                        </button>
                    </form>
                </div>
                        ...
                        <div className="flex">
                            <div className="flex shrink-0 items-center">
                                <Link href="/" className="flex items-center gap-2 sm:gap-4">
                                    ...
                                    <span className="font-bold text-sm sm:text-lg text-gray-800 uppercase tracking-widest sm:tracking-[0.15em] block truncate max-w-[150px] sm:max-w-none">
                                        {appName}
                                    </span>
                                </Link>
                            </div>
                                                ...
                                                <Dropdown.Trigger>
                                                    <button className={`inline-flex items-center px-3 py-2 text-sm font-medium transition h-full border-b-2 ${route().current('developer.payments.*') ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
                                                        <div className="flex items-center gap-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 1.5v.75m0 1.5v.75m11.25-2.25h1.5m-1.5 1.5h1.5m-1.5 1.5h1.5M7.5 12h7.5m-7.5 3h7.5m-7.5 3h7.5" /></svg>
                            ...
                            <div className="relative ms-3">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        {user.role === 'super_admin' ? (
                                            <Dropdown.Link href={route('developer.system.info')}>System Settings</Dropdown.Link>
                                        ) : (
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2">
                        ...
                        {user.role === 'super_admin' && (
                            <>
                                ...
                                <ResponsiveNavLink href={route('developer.payments.pending')} active={route().current('developer.payments.pending')} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 1.5v.75m0 1.5v.75m11.25-2.25h1.5m-1.5 1.5h1.5m-1.5 1.5h1.5M7.5 12h7.5m-7.5 3h7.5m-7.5 3h7.5" /></svg>}>Pending Approvals</ResponsiveNavLink>
                                <ResponsiveNavLink href={route('developer.payments.history')} active={route().current('developer.payments.history')} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 1.5v.75m0 1.5v.75m11.25-2.25h1.5m-1.5 1.5h1.5m-1.5 1.5h1.5M7.5 12h7.5m-7.5 3h7.5m-7.5 3h7.5" /></svg>}>Payment History</ResponsiveNavLink>
                                <ResponsiveNavLink href={route('developer.payments.overdue')} active={route().current('developer.payments.overdue')} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 1.5v.75m0 1.5v.75m11.25-2.25h1.5m-1.5 1.5h1.5m-1.5 1.5h1.5M7.5 12h7.5m-7.5 3h7.5m-7.5 3h7.5" /></svg>}><span className="text-red-600">Overdue Payments</span></ResponsiveNavLink>
                                <ResponsiveNavLink href={route('developer.payments.upcoming')} active={route().current('developer.payments.upcoming')} icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75m0 1.5v.75m0 1.5v.75m11.25-2.25h1.5m-1.5 1.5h1.5m-1.5 1.5h1.5M7.5 12h7.5m-7.5 3h7.5m-7.5 3h7.5" /></svg>}>Upcoming Renewals</ResponsiveNavLink>
